...
class SchemaTest extends TestCase {
	...
	public function test_version_ist_gesetzt(): void {
		...
		$this->assertSame( '0.8.0', Schema::VERSION );
	}

	public function test_getTableNames_enthaelt_alle_tabellen(): void {
		...
		$this->assertContains( 'wp_resa_module_settings', $tables );
		$this->assertContains( 'wp_resa_webhooks', $tables );
		$this->assertContains( 'wp_resa_api_keys', $tables );
		$this->assertContains( 'wp_resa_messengers', $tables );
	}
	...
	public function test_migrate_ruft_dbDelta_und_speichert_version(): void {
		Functions\expect( 'dbDelta' )->atLeast()->once();
	...
	public function test_dropAll_loescht_alle_tabellen_und_option(): void {
		...
		// 10 tables = 10 DROP TABLE queries.
		$this->assertSame( 10, $wpdb->queryCount );
	}
