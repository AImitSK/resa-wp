/**
 * Step 7: Extras — Feature-Checkboxen (like rent-calculator but with solar).
 */
...
const getDefaultFeatures = (): FeatureOption[] => [
	...
	{ key: 'solar', label: __('Solar/PV-Anlage', 'resa'), icon: 'solaranlage' },
];
	...
	return (
		<div className="resa-space-y-4">
			...
			<div className="resa-mt-4 resa-space-y-1.5">
				<Label htmlFor="pv-additional-features">
